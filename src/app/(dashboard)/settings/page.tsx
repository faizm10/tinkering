...
export default async function SettingsPage() {
  ...
  return (
    <div className="max-w-2xl space-y-9">
      <PageHeader title="Settings" description="How Sonae greets you and when it reminds you." />
      ...
      <section>
        ...
        <div className="space-y-3 pt-4">
          <p className="type-body text-body">
            Sonae does not store credentials, government ID numbers, or banking details, and it
